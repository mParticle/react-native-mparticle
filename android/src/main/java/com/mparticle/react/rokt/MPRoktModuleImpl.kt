...
class MPRoktModuleImpl(private val reactContext: ReactApplicationContext) {
    ...
    private val listeners: MutableMap<Long, MpRoktEventCallback> =
        object : LinkedHashMap<Long, MpRoktEventCallback>() {
            override fun removeEldestEntry(eldest: Map.Entry<Long, MpRoktEventCallback>): Boolean =
    ...
    companion object {
        ...
        const val MODULE_NAME = "RNRoktWidget"
    }
}
