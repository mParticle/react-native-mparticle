...
export default class MParticleSample extends Component {
  constructor(props) {
    ...
    this._roktClose = this._roktClose.bind(this);
    this._roktSession = this._roktSession.bind(this);
  ...
  componentDidMount() {
    ...
    if (eventManagerEmitter) {
      ...
      this.roktEventsListener = eventManagerEmitter.addListener(
        'RoktEvents',
        data => {
  ...
  _roktClose() {
    MParticle.Rokt.close()
      .then(() => {
        console.debug('Rokt close called');
      })
      .catch(error => {
        console.debug('Rokt close error: ' + JSON.stringify(error));
      });
  }
  ...
  _roktSession() {
    ...
    MParticle.Rokt.setSessionId(sessionId)
      ...
      .then(currentSessionId => {
        console.debug('Rokt session ID: ' + JSON.stringify(currentSessionId));
      })
      .catch(error => {
        console.debug('Rokt session error: ' + JSON.stringify(error));
      });
  }
  ...
  _roktSelectPlacements(identifier) {
    ...
    MParticle.Rokt.selectPlacements(
      ...
      .then(result => {
        console.debug(
          'Rokt selectPlacements result: ' + JSON.stringify(result),
        );
      })
      .catch(error => {
      ...
      <SafeAreaView style={styles.safeArea}>
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <Text style={styles.infoText}>Opted Out = {optedOut}</Text>
            <Button
              onPress={() => {
                this._toggleOptOut();
              }}
            ...
            <Button
              title="ROKT Embedded"
              onPress={() => {
                this._roktSelectEmbeddedPlacements();
              }}
            />
            <Button
              title="ROKT Overlay"
              onPress={() => {
                this._roktSelectOverlayPlacements();
              }}
            />
            <Button
              title="ROKT BottomSheet"
              onPress={() => {
                this._roktSelectBottomSheetPlacements();
              }}
            />
            <Button
              title="ROKT Close"
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  this._roktSelectPlacements(this.state.customIdentifier)
                }>
                <Text style={styles.primaryButtonText}>
                  Run Custom Placement
                </Text>
              </TouchableOpacity>
            </View>
